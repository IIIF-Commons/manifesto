...
export declare const loadManifest: (uri: string) => Promise<string>;
export declare const parseManifest: (manifest: string, options?: IManifestoOptions | undefined) => IIIFResource | null;
