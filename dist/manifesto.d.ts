...
declare namespace Manifesto {
    class Utils {
        ...
        static attemptResourceWithToken(openTokenService: (tokenService: Manifesto.IService) => Promise<void>, authService: Manifesto.IService, resource: Manifesto.IExternalResource): Promise<boolean>;
