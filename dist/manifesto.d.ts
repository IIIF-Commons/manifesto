...
declare namespace Manifesto {
    class Utils {
        ...
        static attemptResourceWithToken(resource: Manifesto.IExternalResource, openTokenService: (tokenService: Manifesto.IService) => Promise<void>, authService: Manifesto.IService): Promise<boolean>;
